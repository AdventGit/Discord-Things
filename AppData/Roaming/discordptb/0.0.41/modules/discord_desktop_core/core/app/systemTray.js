...
function initializeMenuItems() {
  ...
  menuItems[MenuItems.OPEN] = {
    label: 'Open BetterDiscord-PTB ' + _Constants.APP_NAME,
    type: 'normal',
  ...
  menuItems[MenuItems.CHECK_UPDATE] = {
    label: 'Check for things to ruin themes...',
    type: 'normal',
...
function buildContextMenu() {
  ...
  contextMenu = [menuItems[MenuItems.OPEN], menuItems[MenuItems.VOICE_SETTINGS], menuItems[MenuItems.MUTE], menuItems[MenuItems.DEAFEN], separator, menuItems[MenuItems.CHECK_UPDATE], menuItems[MenuItems.QUIT]];
}
