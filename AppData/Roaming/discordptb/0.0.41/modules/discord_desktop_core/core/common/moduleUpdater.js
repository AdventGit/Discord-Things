...
function init(_endpoint, _settings, _buildInfo) {
  ...
  locallyInstalledModules = buildInfo.localModulesRoot != null;
  ...
  if (locallyInstalledModules) {
    if (_module2.default.globalPaths.indexOf(buildInfo.localModulesRoot) === -1) {
      _module2.default.globalPaths.push(buildInfo.localModulesRoot);
    }
  } else {
